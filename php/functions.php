...
if (!function_exists('add_scripts')) { // если ф-я уже есть в дочерней теме - нам не надо её определять
	function add_scripts() { // добавление скриптов
	    ...
	    wp_enqueue_script('jq-321', get_template_directory_uri().'/js/jquery-3.2.1.min.js','','',true); // jq
	    wp_enqueue_script('foundation', get_template_directory_uri().'/js/foundation.min.js','','',true);
	    wp_enqueue_script('slick', get_template_directory_uri().'/js/slick.min.js','','',true);
		wp_enqueue_script('swiper-bundle', get_template_directory_uri().'/js/swiper-bundle.min.js','','',true);
		wp_enqueue_script('contact', get_template_directory_uri().'/js/contact.js','','',true); // и скрипты шаблона
		wp_enqueue_script('main', get_template_directory_uri().'/js/main.js','','',true); // и скрипты шаблона
		wp_enqueue_script('swiper', get_template_directory_uri().'/js/swiper.js','','',true); // и скрипты шаблона
	}
}
...
if (!function_exists('add_styles')) { // если ф-я уже есть в дочерней теме - нам не надо её определять
	function add_styles() { // добавление стилей
		...
		wp_enqueue_style( 'responsive', get_template_directory_uri().'/css/responsive.css' ); // Адаптив
	}
}
...
if( function_exists('acf_add_options_page') ) {
  ...
  acf_add_options_page(array(
    'page_title' 	=> 'Настройки цен',
    'menu_title'	=> 'Настройки цен',
